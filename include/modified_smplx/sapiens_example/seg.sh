...
### original code from https://github.com/facebookresearch/sapiens/blob/main/lite/scripts/demo/torchscript/seg.sh


cd ../../.. || exit
SAPIENS_ROOT=/data/sapiens
SAPIENS_LITE_ROOT=$SAPIENS_ROOT/lite
SAPIENS_CHECKPOINT_ROOT=/data/pretrain/checkpoints

...
### original code from https://github.com/facebookresearch/sapiens/blob/main/lite/scripts/demo/torchscript/normal.sh


cd ../../.. || exit
SAPIENS_ROOT=/data/sapiens
SAPIENS_LITE_ROOT=$SAPIENS_ROOT/lite
SAPIENS_CHECKPOINT_ROOT=/data/sapiens/pretrain/checkpoints
...
INPUT='/data/sapiens/test/input'
SEG_DIR="/data/sapiens/test/output/actor07/sapiens_1b"
OUTPUT="/data/sapiens/test/output/actor07"
IMAGE_LIST="/data/sapiens/test/input/lst.txt"
